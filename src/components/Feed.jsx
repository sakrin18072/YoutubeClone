...
const Feed = () => {
  ...
  return (
    <div className='d-flex' style={{overflowY:'hidden'}}>
      <div className='col-12 col-md-3 col-lg-2 bg-dark text-light' style={{height:'89.1vh',overflowY:'scroll'}} >
        ...
        <div className='col-12 col-md-9 col-lg-10 bg-dark' style={{height:'89.1vh',overflowY:'scroll'}}>
